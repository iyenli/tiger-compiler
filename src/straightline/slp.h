...
public:
  virtual int MaxArgs() const = 0;
  virtual IntAndTable *Interp(Table *) = 0;
};
...
//  for print things correctly
  virtual IntAndTable *PrintAndInterp(Table *t) = 0;
...
public:
  ...
  IntAndTable *Interp(Table *) override;
  int MaxArgs() const override;
...
public:
  ...
  IntAndTable *PrintAndInterp(Table *t) override;
